        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="mb-8 slide-up">
            <nav className="flex items-center space-x-2 text-sm text-gray-600">
              ...
              <span className="font-medium" style={{ color: '#d4af37' }}>Registration</span>
            </nav>
          </div>
          ...
          <div className="text-center mb-12">
            ...
            Chika’s 4 decades of grace celebration party registration. Fill out the form below to register and use your email for check-in at the event.
            </p>
          </div>
