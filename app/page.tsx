          ...
          >
            ...
            <div className="text-center relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
                <Link
                  href="/register"
                  className="btn-primary text-lg py-4 px-12 rounded-full transform hover:scale-105 transition-all duration-300"
                >
                  Register Now
                </Link>
                <a
                  ...
                  className="inline-flex items-center gap-3 bg-green-600 hover:bg-green-700 text-white font-semibold text-lg py-4 px-8 rounded-full transform hover:scale-105 transition-all duration-300 shadow-lg"
                >
                  <svg
                    className="w-6 h-6"
                    fill="currentColor"
              ...
              <div className="relative">
                <div
                  ...
                  style={{
                    background: "linear-gradient(to right, #f4e4bc, #d4af37)",
                  }}
                >
