          ...
          >
            ...
            <div className="text-center relative z-10">
              ...
              <div className="justify-center items-center mb-12">
                <Link
                  href="/register"
                  className="btn-underline text-lg py-4 px-12 rounded-full transform hover:scale-105 transition-all duration-300 inline-flex items-center gap-2"
                >
                  Chika's Four Decades Of Grace Celebration Party Registration Link.
                  <svg
                ...
                <a
                  ...
                  className="hover:scale-105 mt-4 inline-flex items-center gap-3 text-green-700 font-semibold text-lg py-4 px-8 rounded-full transform  transition-all duration-300 "
                >
                  If you're unable to make it to the event, send Chika your personal regret.
                  <svg
                    className="w-6 h-6 md:w-5 md:h-5"
                    fill="currentColor"
                    viewBox="0 0 24 24"
              ...
              <div className="relative">
                <div
                  className="rounded-lg p-4 relative overflow-hidden bg-[#fef3c7]"
                >
                  <div className="absolute top-0 right-0 w-32 h-full " style={{ background: "linear-gradient(to left, rgba(245, 158, 11, 0.3), transparent)" }}></div>
                  <div className="relative z-10">
                    <div
                      className="font-bold mb-1"
                      style={{ color: "#b8860b" ,  fontFamily: "Dancing Script, cursive", fontWeight: "bold", fontSize: "20px" }}
                    >
                      four decades of
                    </div>
                    <div
                      className="text-xl font-bold"
                      style={{ color: "#1a1a1a",  fontFamily: "Dancing Script, cursive", }}
                    >
                      Grace
                    </div>
                  </div>
